...
namespace N_Pokemon {
    Pokemon::Pokemon(std::string p_name, const PokemonType p_type, const int p_health, const int p_max_health, const int p_attack_power) : name(p_name), type(p_type), health(p_health), max_health(p_max_health), attack_power(p_attack_power) {}
